...
void PickableManager::SetDragCallbacks(
    Object* object,
    DragStartCallback onStart,
    DragUpdateCallback onUpdate,
    DragEndCallback onEnd)
{
    m_objectCallbacks[object].onDragStart = onStart;
    m_objectCallbacks[object].onDragEnd = onEnd;
    m_objectCallbacks[object].onDragUpdate = onUpdate;
}
