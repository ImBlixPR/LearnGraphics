...
namespace Renderer
{
	...
	//render 2d
    void DotedBackground(glm::vec3 color, float size, int numberOfVerticlDot, int numberOfHorizantialDot)
    {
        //temp
        int gap1 = BackEnd::GetWindowCurrentHeight() / (numberOfVerticlDot + 1);
        int gap2 = BackEnd::GetWindowCurrentWidth() / (numberOfHorizantialDot + 1);
